package ug.co.absa.gatewaysrv.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.gatewaysrv.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.gatewaysrv.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ug.co.absa.gatewaysrv.service.InvalidPasswordException
