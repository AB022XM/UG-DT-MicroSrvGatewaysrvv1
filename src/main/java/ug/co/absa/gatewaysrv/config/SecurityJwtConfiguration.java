package ug.co.absa.gatewaysrv.config;

import static ug.co.absa.gatewaysrv.security.SecurityUtils.AUTHORITIES_KEY;
import static ug.co.absa.gatewaysrv.security.SecurityUtils.JWT_ALGORITHM;
